...
6. **Content Update (Resume Links)**: Updated hardcoded Dropbox resume links across the entire project (`constants.ts`, `ArchivedCaseStudy.tsx`, `HydrofoilBoatCaseStudy.tsx`, and `WolfCaseStudy.tsx`) to ensure the newest resume PDF is served universally.
