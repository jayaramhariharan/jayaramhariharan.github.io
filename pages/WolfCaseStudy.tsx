...
const decisionPaths = [
  {
    ...
    body: 'Too bend-sensitive for a one-pass chassis.',
  },
  {
    title: 'Build tall walls.',
    body: 'Safer on paper, but too tippy in side hits.',
  },
  {
    title: 'Keep it low and flat.',
    body: 'One folded shell, low center of gravity, short walls doing structural work.',
  },
];

const resultMetrics = [
  { label: 'Rounds won', value: '6/6', note: 'event total' },
  { label: 'Win rate', value: '100%', note: 'through finals' },
  { label: 'Awards', value: '2', note: 'champion + designer' },
  { label: 'Structural failures', value: '0', note: 'across the event' },
];

const WolfCaseStudy: React.FC = () => {
  const nextProjects = getFooterProjects(2);
      ...
      <main className="relative z-10 bg-[#fbfbfd]">
        ...
        >
          <div className="absolute inset-0 z-0 pointer-events-none">
            ...
            <img
              src={wolfImages.hero}
              alt="Wolf combat robot side view"
              loading="eager"
              decoding="async"
            ...
            {/* mobile hero */}
            <img
              src={wolfImages.heroMobile}
              alt="Wolf combat robot front view"
              loading="eager"
              decoding="async"
          ...
          <div className="relative z-10 h-full w-full pointer-events-none">
            ...
            <div className="absolute bottom-16 left-8 z-20 flex flex-col pointer-events-none md:left-16">
              ...
              >
                Folded from one 5052 sheet. Corrected between rounds with a bolt-on wedge.
              </motion.p>
            </div>
          </div>
        </section>
        ...
        <section className="reveal mx-auto max-w-site px-8 py-24 md:px-16">
          <div className="grid grid-cols-2 gap-12 border-y border-gray-200/60 py-16 md:grid-cols-4">
            <div className="flex flex-col gap-3">
              <span className="font-mono text-[10px] font-medium uppercase tracking-[0.2em] text-[#86868b]">Organizer</span>
              <span className="font-sans text-xl font-medium tracking-tight text-[#1d1d1f]">Propeller Technologies</span>
            </div>
            <div className="flex flex-col gap-3">
              <span className="font-mono text-[10px] font-medium uppercase tracking-[0.2em] text-[#86868b]">Format</span>
              <span className="font-sans text-xl font-medium tracking-tight text-[#1d1d1f]">10-team tournament</span>
            </div>
            <div className="flex flex-col gap-3">
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="flex flex-wrap gap-2">
                {['Sheet Metal', '5052 Al', 'FDM', 'Pit Revision'].map((tag) => (
            ...
            <div className="flex flex-col gap-12 pt-4 lg:col-span-7 lg:pt-16">
              <div className="reveal">
                <p className="font-sans text-xl font-light leading-relaxed tracking-tight text-[#86868b] md:text-2xl">
                  One fabrication pass meant the chassis had to fold cleanly, stay low, and survive side hits.
                </p>
              </div>
              ...
              <div className="reveal delay-100 mt-4">
                <div className="border-l border-gray-300 pl-6 md:pl-8">
                  ...
                  <p className="font-sans text-xl md:text-2xl font-normal leading-relaxed text-[#1d1d1f] tracking-tight">
                    Design it right once. Leave the nose easy to revise.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="mx-auto max-w-site overflow-hidden px-8 py-24 md:px-16 md:py-32">
          <div className="reveal mx-auto max-w-5xl text-center">
            <p className="font-display text-3xl font-medium leading-snug tracking-tight text-[#1d1d1f] md:text-4xl">
              "The sheet is not the armor. It has to fold cleanly, stay low, and let the walls do structural work."
            </p>
          </div>
        </section>
          ...
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-12 lg:gap-24">
            ...
            <div className="flex flex-col gap-10 lg:col-span-8">
              <figure className="reveal overflow-hidden rounded-[2.5rem] border border-gray-200 bg-white p-6 shadow-[0_20px_60px_rgba(0,0,0,0.06)] md:p-8">
                <div
                  className="overflow-hidden rounded-[2rem] bg-[#f8f8f4]"
                  style={{ aspectRatio: '16 / 9' }}
                >
                  <img
                    src={wolfImages.decision}
                    alt="Wolf iso view showing low chassis"
                    loading="lazy"
                    className="h-full w-full object-contain"
                  />
                </div>
                <figcaption className="mt-6 flex items-center justify-between gap-4 text-xs uppercase tracking-[0.18em] text-[#86868b]">
                  <span className="font-mono">Iso view</span>
                  <span className="font-sans text-[11px] font-medium text-[#1d1d1f]">Low shell / wide stance</span>
                </figcaption>
              </figure>
        ...
        <section className="mx-auto max-w-site px-8 py-24 md:px-16 md:py-32">
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
            <figure className="group reveal rounded-[2.5rem] border border-gray-200 bg-white p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)]">
              <div className="overflow-hidden rounded-[2rem] bg-[#f8f8f4]" style={{ aspectRatio: '9 / 16' }}>
                <img src={wolfImages.before} alt="Wolf before wedge fix" loading="lazy" className="h-full w-full object-contain" />
              </div>
              <div className="mt-6 font-mono text-[10px] uppercase tracking-[0.2em] text-[#86868b]">Before</div>
              <figcaption className="mt-1 font-sans text-sm text-[#86868b]">Flat nose, weak first contact.</figcaption>
            </figure>

            <figure className="group reveal delay-100 rounded-[2.5rem] border border-gray-200 bg-white p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] md:mt-10">
              <div className="overflow-hidden rounded-[2rem] bg-[#f8f8f4]" style={{ aspectRatio: '9 / 16' }}>
                <img src={wolfImages.detail} alt="Close-up of wedge geometry" loading="lazy" className="h-full w-full object-contain" />
              </div>
              <div className="mt-6 font-mono text-[10px] uppercase tracking-[0.2em] text-[#86868b]">Detail</div>
              <figcaption className="mt-1 font-sans text-sm text-[#86868b]">Lower entry point.</figcaption>
            </figure>

            <figure className="group reveal delay-200 rounded-[2.5rem] border border-gray-200 bg-white p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)]">
              <div className="overflow-hidden rounded-[2rem] bg-[#f8f8f4]" style={{ aspectRatio: '9 / 16' }}>
                <img src={wolfImages.after} alt="Wolf after wedge fix" loading="lazy" className="h-full w-full object-contain" />
              </div>
              <div className="mt-6 font-mono text-[10px] uppercase tracking-[0.2em] text-[#86868b]">After</div>
              <figcaption className="mt-1 font-sans text-sm text-[#86868b]">Bolt-on fix, no rebuild.</figcaption>
            </figure>
          </div>
        </section>
        ...
        <section className="mx-auto max-w-site px-8 py-24 md:px-16 md:py-32">
          <div className="reveal mb-20 flex flex-col items-start justify-between md:flex-row md:items-end">
            <div>
              <div className="mb-6 font-mono text-[10px] font-medium uppercase tracking-[0.2em] text-[#86868b]">04 &mdash; Results</div>
              <h2 className="font-display text-5xl font-semibold leading-[1.05] tracking-tighter text-[#1d1d1f] md:text-7xl">Outcome.</h2>
            </div>
          </div>

          <div className="grid grid-cols-2 gap-px overflow-hidden rounded-[2.5rem] bg-black/10 md:grid-cols-4">
            {resultMetrics.map((metric) => (
              <article key={metric.label} className="reveal bg-[#f8f8f4] p-8 md:p-10">
                <div className="font-mono text-[10px] font-medium uppercase tracking-[0.2em] text-[#86868b]">{metric.label}</div>
                <div className="mt-4 font-display text-4xl font-semibold tracking-tight text-[#1d1d1f] md:text-5xl">{metric.value}</div>
                <p className="mt-2 font-sans text-sm leading-relaxed text-[#86868b]">{metric.note}</p>
              </article>
            ))}
          </div>
        </section>
